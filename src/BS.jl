...
"""
    d1(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64)

Compute the d1 score used to determine the risk-adjusted probability that the option will be in-the-money.

# Examples
```julia-repl
julia> d1(100., 0., 0.05, 0.2, 110, 1.0)
-0.12655089902162442
```
"""
function d1(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64)
    return (log(S/K) + ((r - q) + 0.5*vol^2)*tau)/(vol*sqrt(tau))
end

"""
    d2(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64)

Compute the d2 score used to determine the probability that the option will not be in-the-money.

# Examples
```julia-repl
julia> d2(100., 0., 0.05, 0.2, 110, 1.0)
-0.32655089902162443
```
"""
function d2(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64)
    return (log(S/K) + ((r - q) - 0.5*vol^2)*tau)/(vol*sqrt(tau))
end
...
"""
    compute_value(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
...
# Examples
```julia-repl
julia> compute_value(100., 0.05, 0.2, 110., 1., true)
6.040088129724232
```
"""
function compute_value(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
    if is_call
...
"""
    compute_delta(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
...
# Examples
```julia-repl
julia> compute_delta(100., 0.05, 0.2, 110., 1., true)
0.44964793063717595
```
"""
function compute_delta(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
    if is_call
...
"""
    compute_vega(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
...
# Examples
```julia-repl
julia> compute_vega(100., 0.0, 0.05, 0.2, 110., 1., true)
39.57604803881934
```
"""
function compute_vega(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
...
"""
    compute_theta(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
...
# Examples
```julia-repl
julia> compute_theta(100., 0.0, 0.05, 0.2, 110., 1., true)
-5.903840050581602
```
"""
function compute_theta(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
    if is_call
...
"""
    compute_rho(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
...
# Examples
```julia-repl
julia> compute_rho(100., 0.0, 0.05, 0.2, 110., 1., true)
38.92470493399336
```
"""
function compute_rho(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
    if is_call
...
"""
    compute_gamma(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
...
# Examples
```julia-repl
julia> compute_gamma(100., 0.0, 0.05, 0.2, 110., 1., true)
0.019788024019409666
```
"""
function compute_gamma(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
    if is_call  # Both expressions are actually equal
...
"""
    compute_vanna(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
...
# Examples
```julia-repl
julia> compute_vanna(100., 0.0, 0.05, 0.2, 110., 1., true)
0.6461797033399724
```
"""
function compute_vanna(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
    return -df(q, tau)*φ(d1(S, q, r, vol, K, tau))*d2(S, q, r, vol, K, tau)/vol
end

"""
    compute_volga(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
...
# Examples
```julia-repl
julia> compute_volga(100., 0.0, 0.05, 0.2, 110., 1., true)
8.17746223872001
```
"""
function compute_volga(S::Float64, q::Float64, r::Float64, vol::Float64, K::Float64, tau::Float64, is_call::Bool)
    return df(q, tau)*S*sqrt(tau)*φ(d1(S, q, r, vol, K, tau))*d1(S, q, r, vol, K, tau)*d2(S, q, r, vol, K, tau)/vol
end

"""
    compute_implied_vol(S::Float64, q::Float64, r::Float64, V::Float64, K::Float64, tau::Float64, is_call::Bool, vol::Float64=0.3, max_iter::Int64=100, tol::Float64=1e-8)
...
# Examples
```julia-repl
julia> compute_implied_vol(100., 0.0, 0.05, 6.040088129724232, 110., 1., true)
0.19999999999999993
```
"""
function compute_implied_vol(S::Float64, q::Float64, r::Float64, V::Float64, K::Float64, tau::Float64, is_call::Bool, vol::Float64=0.3, max_iter::Int64=100, tol::Float64=1e-8)
    for _ in 1:max_iter
        price = compute_value(S, q, r, vol, K, tau, is_call)
        vega = compute_vega(S, q, r, vol, K, tau, is_call)
        diff = V - price
        if abs(diff) < tol
            return vol
        end
